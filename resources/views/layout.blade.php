    ...
    <div class="container mt-4">
        ...
        @foreach ($stocks as $stock)
            ...
            <table class="table table-bordered">
                <tr>
                    <td class="text-end fw-bold">TOTAL LOT</td>
                    <td class="fw-bold">{{ $stock->total_lot }}</td>
                </tr>
                <tr>
                    <td class="text-end fw-bold">TOTAL INVESTED</td>
                    <td class="fw-bold">{{ number_format($stock->total_invested, 2) }}</td>
                </tr>
                <tr>
                    <td class="text-end fw-bold">AVERAGE PRICE</td>
                ...
                <tr>
                    <td class="text-end fw-bold">AVERAGE PROFIT (%)</td>
